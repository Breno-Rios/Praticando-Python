'''
Lucas está desenvolvendo um sistema de monitoramento ambiental.
 Para isso, ele precisa criar sensores assíncronos que coletam dados periodicamente, sem que o programa fique travado esperando por cada um.
